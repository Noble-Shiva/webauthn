...
import { login, setLoggerCallback } from '../api/auth';
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (!username) {
      ...
      addLog('error', 'Login failed - Empty username');
      return;
    }
    ...
    try {
      ...
      addLog('info', 'User logged in successfully', { user: response.user });
      setUsername('');
    } catch (error) {
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">
            Login with your biometric authenticator
          </p>
        </div>
